...
class Movie {
    ...
    static async createMovie({ title, description, release_year, user_id, last_active }) {
        const result = await pool.query(
    ...
    static async updateMovie(id, { title, description, release_year, user_id, last_active }) {
        const result = await pool.query(
